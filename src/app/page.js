 ...
 <section id="FAQSection">
      ...
      <section className=" bg-green-50 rounded-2xl p-10 text-center">
        ...
        <p className="text-gray-700  max-w-2xl mx-auto mb-6" >
          АГРО-СИТИ” системийн тусламжтайгаар та газрын төлөвлөлт, усалгааны менежмент, ургацын таамаглалыг <strong>бүрэн автомат, ухаалаг хэлбэрээр удирдах </strong>боломжтой.
        </p>
      </section>
    </main >
  );
