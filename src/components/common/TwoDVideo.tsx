...
const TwoDVideo = () => {
    return (
        <section className="relative w-full bg-slate-50 py-10 px-6 md:px-16">
            {/* Гарчиг хэсэг */}
            <div className="text-center max-w-3xl mx-auto mb-10">
                <h1
                    className="text-3xl md:text-5xl font-roboto-bold text-green-950 uppercase mb-4 tracking-wide"
            ...
            <div className="flex flex-col items-center justify-center">
                <div className="relative w-full max-w-5xl h-[600px] bg-white  shadow-lg flex items-center justify-center overflow-hidden">
                    <Suspense
                        fallback={
