...
//           <h2 className="text-3xl md:text-4xl font-roboto-bold text-[#0F5132]">Хууль эрх зүй</h2>
//           <p className="mt-3 text-gray-700 max-w-2xl mx-auto" style={{ fontFamily: 'RobotoRegular' }}>
  ...
  return (
    <section id="law" className="py-20 px-6 md:px-12 bg-gradient-to-b from-[#f9fff9] via-[#f3fdf5] to-[#ebfaef]">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-roboto-bold text-[#0F5132]">
