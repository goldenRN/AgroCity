...
//         {/* Доорх 3 таб */}
//         <div className="flex flex-col md:flex-row justify-center bg-slate-100 border-t border-slate-200 items-stretch w-full max-w-6xl mx-auto text-green-950  text-lg">
//           {tabs.map((tab) => (
//             <button
//               key={tab.key}
  ...
  return (
    <section className="relative w-full bg-slate-50  ">
      ...
      <div className="flex flex-col items-center justify-between ">
        <div className="max-w-7xl w-full px-10 h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] shadow-lg flex items-center justify-center overflow-hidden">
          <Suspense
            fallback={
              <div className="flex items-center justify-center text-green-800">
        ...
        {/* Доорх 3 таб */}
        <div className="max-w-7xl flex flex-col px-10 md:flex-row justify-center  border-t border-slate-200 items-stretch w-full max-w-6xl mx-auto text-green-950 text-sm sm:text-base md:text-lg ">
          {tabs.map((tab) => (
            <button
              key={tab.key}
              onClick={() => setSelectedModel(tab.key)}
